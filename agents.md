# VidyScaler - Система ИИ-реставрации видео

## 🎯 Назначение системы
VidyScaler - это нативное macOS приложение для профессиональной реставрации старых видео 360p из 90х-2000х годов. Превращает зернистые, артефактные видео в четкие HD/4K с помощью современных ИИ-алгоритмов.
...
1. `~/Documents/Coding/VidyScaler/bin/` (рекомендуемо)
2. `/opt/homebrew/bin/`
3. `/usr/local/bin/`
...
# 3. Запуск
# Приложение откроется автоматически в ~/Applications/VidyScaler.app
```

### Workflow пользователя:
1. **Запуск:** VidyScaler из Applications
...
cd ~/Documents/coding/VidyScaler/
...
*Версия VidyScaler: 1.1 (Core ML в разработке)*  
